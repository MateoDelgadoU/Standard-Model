...
export function StandardModelTable({ onParticleClick, showAntiparticles, onToggleAntiparticles }: Props) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      {/* Main layout: fermions left, bosons right */}
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex gap-3 sm:gap-4">
            {/* Quarks */}
            <div className="flex-1 min-w-0">
              <div className="text-[9px] sm:text-[10px] text-white/20 uppercase tracking-[0.15em] mb-2 text-center">
                Quarks
              </div>
              ...
              <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mt-1">
                <div className="text-center"><span className="text-[8px] text-white/15">I</span></div>
                <div className="text-center"><span className="text-[8px] text-white/15">II</span></div>
                <div className="text-center"><span className="text-[8px] text-white/15">III</span></div>
              </div>
            </div>
        ...
        {/* Bosons */}
        <div className="w-[140px] sm:w-[170px] md:w-[200px] shrink-0">
          <div className="text-[9px] sm:text-[10px] text-white/20 uppercase tracking-[0.15em] mb-2 text-center">
            Bosons
          </div>
          <div className="grid grid-cols-2 gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
            {card('gluon')}{card('photon')}
          </div>
          <div className="grid grid-cols-2 gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
            {card('z-boson')}{card('w-boson')}
          </div>
